...
use Perception\Libraries\Payment\Exceptions\PaymentGatewayException;
...
class CCAvenueGateway implements PaymentGatewayInterface
{
    ...
    public function request($parameters)
    {
        ...
        Log::info('ccavenue get encrypted key', ['encreq' => $this]);
        return $this;
    }
    ...
    public function send()
    {
        ...
        return View::make('vendor.payment.ccavenue')
            ...
            ->with('endPoint', $endpoint . 'initiateTransaction');
    }
    ...
    private function getOrderStatus($parsedData = [])
    {
        try {
            ...
            dd(['Exception while decrepting the enc_response', $e]);
